...
public class JHMjava8Test {
    ...
    @Measurement(iterations = 5, time = 5, batchSize = 10)
    @Benchmark
    public void testIntStream(Blackhole blackhole) {
        List<Long> holder = new ArrayList<>();
        holder.add(0L);
    ...
    public static void test() throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(JHMjava8Test.class.getSimpleName())
